...
var MongoLogStream = require('bunyan-mongodb-stream')({model: LogEntryModel});
...
var LogEntryModel = require('./../models/logs');
...
module.exports = function (port) {
    ...
    io.on('connection', function (socket) {
        ...
        socket.on('task:error', function (err, taskJSON) {
            console.log('Worker error', err, taskJSON);
            //Log.info('info message');
            //Log.warn('warn message');
            Log.error(new Error('email logging test'), 'Something bad happened');

//            transporter.sendMail({
//                from: 'test@dev1.org',
//                to: 'leighton@obdstudios.com',
//                subject: 'error notification test',
//                text: 'test'
//            });
